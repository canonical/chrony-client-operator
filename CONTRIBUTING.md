...
This document explains the processes and practices recommended for contributing enhancements to the Chrony Client charm.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/chrony-client-operator/issues) explaining your use case.
...
Canonical welcomes contributions to the Chrony Client charm. Please check out our
...
```
git clone https://github.com/canonical/chrony-client-operator
```
